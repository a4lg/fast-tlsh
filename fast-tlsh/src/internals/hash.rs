...
use crate::internals::hash::checksum::{FuzzyHashChecksum, FuzzyHashChecksumData};
...
///
/// This type is used as an inner representation of [`crate::hash::FuzzyHash`].
...
///
/// This trait is implemented by [`FuzzyHash`](crate::hash::FuzzyHash).
...
where
    ...
    VerboseFuzzyHashParams<SIZE_CKSUM, SIZE_BODY, SIZE_BUCKETS, SIZE_IN_BYTES, SIZE_IN_STR_BYTES>:
        ConstrainedVerboseFuzzyHashParams,
{
    type Value = FuzzyHash<SIZE_CKSUM, SIZE_BODY, SIZE_BUCKETS, SIZE_IN_BYTES, SIZE_IN_STR_BYTES>;
