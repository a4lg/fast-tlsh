...
///
/// This trait is implemented by [`Generator`](crate::generate::Generator).
...
> where
    ...
    VerboseFuzzyHashParams<SIZE_CKSUM, SIZE_BODY, SIZE_BUCKETS, SIZE_IN_BYTES, SIZE_IN_STR_BYTES>:
    ...
    LengthProcessingInfo<SIZE_BUCKETS>: ConstrainedLengthProcessingInfo,
{
    ...
    pub(crate) buckets: FuzzyHashBucketsData<SIZE_BUCKETS>,
    ...
    pub(crate) checksum: FuzzyHashChecksumData<SIZE_CKSUM, SIZE_BUCKETS>,
    ...
    pub(crate) tail: [u8; WINDOW_SIZE - 1],
...
where
    ...
    FuzzyHashBucketsInfo<SIZE_BUCKETS>:
        FuzzyHashBucketMapper<RawBodyType = [u8; SIZE_BODY], RawBucketType = [u32; SIZE_BUCKETS]>,
    FuzzyHashChecksumData<SIZE_CKSUM, SIZE_BUCKETS>: FuzzyHashChecksum,
    VerboseFuzzyHashParams<SIZE_CKSUM, SIZE_BODY, SIZE_BUCKETS, SIZE_IN_BYTES, SIZE_IN_STR_BYTES>:
        ConstrainedVerboseFuzzyHashParams,
    LengthProcessingInfo<SIZE_BUCKETS>: ConstrainedLengthProcessingInfo,
    ...
    LengthProcessingInfo<SIZE_BUCKETS>: ConstrainedLengthProcessingInfo,
{
    ...
    fn finalize_with_options(
        ...
        if q3 == 0 {
            if !options
                .incompat_flags
                .contains(TLSHIncompatibleGeneratorFlags::ALLOW_STATISTICALLY_WEAK_BUCKETS_QUARTER)
            {
        ...
        FuzzyHashBucketsInfo::<SIZE_BUCKETS>::aggregate_buckets(&mut body, &buckets, q1, q2, q3);
